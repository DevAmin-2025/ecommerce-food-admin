...
@section('content')
    ...
    <form action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="is_on_sale_from"
                value="{{ $product->is_on_sale_from ? toJalali($product->is_on_sale_from) : '' }}"
                type="text" class="form-control" />
            <div class="form-text text-danger">
                @error('is_on_sale_from')
                    {{ $message }}
                @enderror
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="is_on_sale_to"
                value="{{ $product->is_on_sale_to ? toJalali($product->is_on_sale_to) : '' }}" type="text"
                class="form-control" />
            <div class="form-text text-danger">
                @error('is_on_sale_to')
                    {{ $message }}
