...
@section('content')
    ...
    <div class="row gy-4 mb-5">
        ...
        <div class="col-md-3">
            ...
            <input disabled type="text" value="{{ $product->status ? 'فعال' : 'غیرفعال' }}" class="form-control" />
        </div>
        ...
        <div class="col-md-3">
            ...
            <input disabled type="text"
                value="{{ $product->is_on_sale_from ? toJalali($product->is_on_sale_from) : '' }}" class="form-control" />
        </div>

        <div class="col-md-3">
            <label class="form-label">تاریخ پایان حراجی</label>
            <input disabled type="text" value="{{ $product->is_on_sale_to ? toJalali($product->is_on_sale_to) : '' }}"
                class="form-control" />
        </div>
