...
@section('content')
    ...
    <form action="{{ route('coupon.update', $coupon->id) }}" method="POST" class="row gy-4">
        @csrf
        @method('PUT')
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <input name="percentage" value="{{ $coupon->percent }}" type="text" class="form-control" />
            <div class="form-text text-danger">
                @error('percentage')
                    {{ $message }}
                @enderror
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="expire_at" value="{{ toJalali($coupon->expire_date) }}" type="text" class="form-control" />
            <div class="form-text text-danger">
                @error('expire_at')
                    {{ $message }}
                @enderror
